...
import {IApeCoinVault} from "./interfaces/IApeCoinVault.sol";

/**
 * @title ApeCoinVault
 * @author 0xFusion (https://0xfusion.com)
 * @dev ApeCoinVault is a ERC4626 compliant vault for ApeCoin auto-compounded staking.
 * @dev The ERC4626 "Tokenized Vault Standard" is defined in https://eips.ethereum.org/EIPS/eip-4626[EIP-4626].
 */
contract ApeCoinVault is IApeCoinVault, ERC4626, Ownable {
    /* ========== STATE VARIABLES ========== */
